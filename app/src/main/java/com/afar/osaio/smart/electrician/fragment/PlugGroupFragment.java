...
public class PlugGroupFragment extends Fragment implements ICreateGroupView {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.plug_group_fragment, container, false);
    ...
    private void initData() {
        ...
        mCreateCroupPresenter.loadDevices(ConstantValue.SMART_PLUG_PRODUCTID);
    }

    public SelectedDeviceAdapter getPlugAdapter() {
    ...
    public void notifyLoadDevicesSuccess(List<GroupDeviceBean> devices) {
        if (devices != null && devices.size() > 0) {
            mGroups = devices;
            NooieLog.e("-------------pluggroup notifyLoadDevicesSuccess    " + devices.size());

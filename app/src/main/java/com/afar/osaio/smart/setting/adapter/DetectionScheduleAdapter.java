...
public class DetectionScheduleAdapter extends RecyclerView.Adapter<DetectionScheduleAdapter.DetectionScheduleViewHolder> {
    ...
    public DetectionScheduleViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(NooieApplication.mCtx).inflate(R.layout.item_detection_schedule, parent, false);
        ...
        holder.btnItemScheduleSwitch.setOnCheckedChangeListener(new SwitchButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(SwitchButton view, boolean isChecked) {
                if (mListener != null) {
                    ...
                    mListener.onItemSwitch(schedule);
                }
            }
        });
    }
    ...
    public interface DetectionScheduleListener {
        void onItemClick(DetectionSchedule schedule);
        void onItemSwitch(DetectionSchedule schedule);
    }

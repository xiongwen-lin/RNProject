 ...
 * @date 2019/3/22
 */
public class HomeListPopAdapter extends RecyclerView.Adapter<HomeListPopAdapter.HomeHomeListViewHolder> {
    ...
    public HomeHomeListViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(NooieApplication.mCtx).inflate(R.layout.item_home_list_new, parent, false);

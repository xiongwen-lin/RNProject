 ...
 * @date 2019/3/22
 */
public class HomeListAdapter extends RecyclerView.Adapter<HomeListAdapter.HomeHomeListViewHolder> {
    ...
    public HomeHomeListViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(NooieApplication.mCtx).inflate(R.layout.item_activity_home_list, parent, false);

...
public class NiceSpinner extends AppCompatTextView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        int defaultPadding = DisplayUtil.dpToPx(NooieApplication.mCtx, 12);// resources.getDimensionPixelSize(R.dimen.one_and_a_half_grid_unit);

        setGravity(Gravity.CENTER_VERTICAL | Gravity.START);
        //setPadding(0, defaultPadding, defaultPadding, defaultPadding);
        setTextColor(ContextCompat.getColor(NooieApplication.mCtx, R.color.theme_white));
        setClickable(true);
        ...
        listView.setBackgroundColor(ContextCompat.getColor(NooieApplication.mCtx, R.color.white));

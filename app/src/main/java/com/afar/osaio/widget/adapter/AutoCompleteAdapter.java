...
public class AutoCompleteAdapter extends BaseAdapter implements Filterable {
    ...
    private void initViewHeight() {
        View view = inflater.inflate(R.layout.layout_auto_complete, null);
        RelativeLayout linearLayout = view.findViewById(R.id.layout_item);
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.layout_auto_complete, null);
            holder.tv = convertView.findViewById(R.id.tv_simple_item);
            holder.iv = convertView.findViewById(R.id.iv_simple_item);

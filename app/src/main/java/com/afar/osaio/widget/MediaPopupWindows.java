...
public class MediaPopupWindows extends PopupWindow {
    ...
    private OnClickMediaListener myOnClick;
    ...
    public MediaPopupWindows(Activity context, OnClickMediaListener myOnClick) {
        super(context);
    ...
    private void Init() {
        ...
        mMenuView = inflater.inflate(R.layout.pop_media, null);
        ImageView ivFacebook = mMenuView
                .findViewById(R.id.ivFacebook);
        ImageView ivYoutube = mMenuView
                .findViewById(R.id.ivYoutube);
        ImageView ivInstagram = mMenuView
                .findViewById(R.id.ivInstagram);
        ImageView ivEmail = mMenuView
        ...
        ivYoutube.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                if (myOnClick != null) myOnClick.onYoutubeClick();
                dismiss();
            }
        });

 ...
 */
public class UtcPlaybackDateAdapter extends RecyclerView.Adapter<UtcPlaybackDateAdapter.DateViewHolder> {
    ...
    public UtcPlaybackDateAdapter(Context mCtx, boolean isHorizontal) {
        this.mCtx = mCtx;
    ...
    public void onBindViewHolder(@NonNull DateViewHolder dateViewHolder, int i) {
        ...
        */
        ...
        dateSb.append(DateTimeUtil.isTodayUtc(timeInMillis) ? mCtx.getString(R.string.message_today) : DateTimeUtil.getUtcDisplayName(NooieApplication.mCtx, timeInMillis, Calendar.DAY_OF_WEEK, Calendar.SHORT));
        dateSb.append(" ");
        dateSb.append(DateTimeUtil.getUtcTimeString(timeInMillis, PATTERN_MD_1));

package com.afar.osaio.testrn.widget;
...
public class YRRoundProgress extends View {
    private String TAG= YRRoundProgress.class.getSimpleName();
    /**
     * 画笔对象的引用
     */
    private Paint paint;
    ...
    public YRRoundProgress(Context context) {
        this(context, null);
    }

    public YRRoundProgress(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public YRRoundProgress(Context context, AttributeSet attrs, int defStyle) {

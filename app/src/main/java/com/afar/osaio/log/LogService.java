...
public class LogService extends Service {
    ...
    public void createLogCollector() {
        // 日志文件名称
        String logFileName = sdf.format(new Date()) + ".txt";
        List<String> commandList = new ArrayList<>();
        commandList.add("logcat");
        //commandList.add("-f");
        //commandList.add("-d");
        commandList.add(">" + LOG_PATH_SDCARD_DIR + File.separator + logFileName);

...
public class ConvenientBanner<T> extends RelativeLayout {
    ...
    public ConvenientBanner setPageIndicator(int[] page_indicatorId) {
        ...
        for (int count = 0; count < mDatas.size(); count++) {
            ...
            pointView.setLayoutParams(new MarginLayoutParams(ScreenUtil.dip2px(getContext(),15),ScreenUtil.dip2px(getContext(), 15)));
            pointView.setPadding(ScreenUtil.dip2px(getContext(),4), 0, ScreenUtil.dip2px(getContext(),4), 0);

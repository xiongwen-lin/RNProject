...
public class MaterialItemView extends BaseTabItem {
    ...
    public MaterialItemView(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.item_material, null, false);
        addView(view);

        mItemBg = view.findViewById(R.id.itemBg);
...
//            mIcon.setTranslationY(0);
        ...
        if (mChecked) {
            ...
            mItemBg.setBackgroundColor(Color.TRANSPARENT);
        } else {
            mIcon.setImageDrawable(mDefaultDrawable);

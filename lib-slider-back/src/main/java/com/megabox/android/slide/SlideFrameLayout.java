...
/**
 * 处理向右滑动的逻辑，移动整个View，请参数{SlidingPaneLayout}
 *
 * @author lihong
 * @since 2016-3-10
 */
class SlideFrameLayout extends ViewGroup {
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        try {
            ...
            if (!mCanSlide || getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE) {
    ...
    private void onPanelDragged(int newLeft) {
        Log.e("-->>onPanelDragged", " newLeft:" + newLeft);

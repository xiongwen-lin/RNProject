...
public class SlideBackFragmentActivity extends FragmentActivityInterfaceImpl implements SlideFrameLayout.SlidingListener {
    ...
    public void setContentView(int layoutResID) {
        ...
        this.setContentView(LayoutInflater.from(this).inflate(layoutResID, null, false));
    }
    ...
    public void onPanelSlide(View panel, float slideOffset) {
        Log.e("-->>onPanelSlide", " slideOffset:" + slideOffset);
        if (slideOffset <= 0) {
    ...
    public void continueSettling(View panel, boolean settling) {
        Log.e("-->>continueSettling", " settling:" + (settling ? "true" : "false"));

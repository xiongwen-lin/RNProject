 ...
 */
public class SelectAreaIwaView extends FrameLayout {
    ...
    public SelectAreaIwaView(Context context) {
        super(context);
        init(null);
    }

    public SelectAreaIwaView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public SelectAreaIwaView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(attrs);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public SelectAreaIwaView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
...
//        overlayView.setNewBoundsListener(imageView);
        setNewBoundsListener();
        addOnNewBoundsListener(imageView);
    ...
    public void setCropRect(RectF rectF) {
        if (rectF == null || overlayView == null) {
            return;
        }
        overlayView.setCropRect(rectF);
    }
    ...
    public void setDrawOverlay(boolean shouldDraw) {
        ...
        overlayView.setDrawOverlay(shouldDraw);
    }

    public void setIsCropDragEnable(boolean enable) {
        if (overlayView == null) {
            return;
        }
        overlayView.setIsCropDragEnable(enable);
    }

    public void setNewBoundsListener() {
        if (overlayView == null) {
            return;
        }
        overlayView.setNewBoundsListener(new OnNewBoundsListener() {
            @Override
            public void onNewBounds(RectF bounds) {
                for (OnNewBoundsListener onNewBoundsListener : mNewBoundsListeners) {
                    if (onNewBoundsListener != null) {
                        onNewBoundsListener.onNewBounds(bounds);
                    }
                }
            }
        });
    ...
    private List<OnNewBoundsListener> mNewBoundsListeners = new ArrayList<>();
    public void addOnNewBoundsListener(OnNewBoundsListener onNewBoundsListener) {
        if (onNewBoundsListener == null) {
            return;
        }
        if (mNewBoundsListeners == null) {
            mNewBoundsListeners = new ArrayList<>();
        }
        mNewBoundsListeners.add(onNewBoundsListener);
    }

    public void clearOnNewBoundsListeners() {
        if (mNewBoundsListeners != null) {
            mNewBoundsListeners.clear();
        }
    }

    public void setOnBoundshangeListener(OnBoundsChangeListener listener) {
        if (overlayView == null) {
            return;
        }
        overlayView.setOnBoundsChangeListener(listener);
    }

 ...
 */
package com.nooie.widget.widget;
...
import com.nooie.widget.R;

/**
 * Created by YanZhenjie on 2017/7/21.
 */
public class DefaultLoadMoreView extends LinearLayout implements NooieSwipeRecyclerView.LoadMoreView, View.OnClickListener {

    private ProgressBar mProgressBar;
    private TextView mTvMessage;

    private NooieSwipeRecyclerView.LoadMoreListener mLoadMoreListener;
    ...
    @Override
    public void onWaitToLoadMore(NooieSwipeRecyclerView.LoadMoreListener loadMoreListener) {
